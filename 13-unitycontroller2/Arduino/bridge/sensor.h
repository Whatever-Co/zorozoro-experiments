...
class SensorInfo : public BLEClientCharacteristic {
   private:
    static uint8_t UUID[];

   public:
    SensorInfo() : BLEClientCharacteristic(SensorInfo::UUID) {}
...
uint8_t SensorInfo::UUID[] = {0xAE, 0xBB, 0xD7, 0xFC, 0x3E, 0xCF, 0x08, 0x95, 0x71, 0x45, 0x3B, 0x5B, 0x06, 0x01, 0xB2, 0x10};
